...
@Slf4j
@AllArgsConstructor
public class SolrServerEndpointSelectorBeanPostProcessor implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        for(String name: endpointNames) {
            ...
            registry.registerBeanDefinition(SolrServerEndpointSelector.class.getName()+"#"+name, searchSelector);
        }
    }
    ...
    private BeanDefinition createSelector(String name, BeanDefinition searchEndpoint) {
        GenericBeanDefinition beanDefinition = new GenericBeanDefinition();
        beanDefinition.setBeanClassName("eu.xenit.alfresco.healthprocessor.plugins.solr.endpoint.${"+PROPERTY_PREFIX+name+".type}SolrServerEndpointSelector");
